...
## LA Property Markets — Sector by Sector
...
→ Cross-references: [National CRE Trends](#national-cre-and-cross-sector-context) for retail and multifamily national sector scorecard.

---

## Specialized Sector

*Deep dives into sectors that don't fit cleanly into the LA-market-by-sector frame.*

**[Life Sciences](wiki/life-sciences.md)**
61M SF available nationally at ~29% availability rate — historic tenant's market; AI-native biotechs leasing 1/3 less space than traditional tenants; LA ranked 3rd in AI life sciences integration (behind Bay Area and Boston); 18.7M SF projected to shift to alternative uses by 2030. JLL-only sources — no CBRE/C&W cross-validation.
→ Cross-references: [LA Office Market](wiki/la-office-market.md) for adaptive reuse context (distressed lab space converting to other uses); [National CRE Trends](#national-cre-and-cross-sector-context) for where life sciences fits the sector scoreboard.

---

## Investment & Capital Markets

*Deal flow, cap rates, buyer types, and the investment thesis for LA CRE.*

**[Capital Markets & Investment](wiki/capital-markets.md)**
LA sales reached $37.3B in 2025 (up from $33B in 2024, still below $51.4B in 2019); private capital 61.4% of buyers — highest share in a decade; CBRE projects national CRE investment rises 16% to $562B in 2026; value-add thesis at distressed pricing (Sunset Media Center at $61M, 51% occupied).
→ Cross-references: [Macro Environment](#macro--demand-drivers) for the rate-cycle causal chain driving deal volume recovery; [LA Office Market](wiki/la-office-market.md) for Sunset Media Center and Oaktree Capital deal specifics; [LA Industrial Market](wiki/la-industrial-market.md) for Q4 2025 $1.2B SoCal industrial sales and owner-user activity.

---

## Macro & Demand Drivers

*The foundational "why" — what moves CRE markets and how LA fits the national picture.*

**[Macro Environment & Demand Drivers](wiki/macro-environment.md)**
Interest rate cycle → valuation reset → 2025 recovery causal chain; employment in office-using sectors as leading indicator for office leasing; e-commerce and reshoring driving industrial demand; CRE loan delinquency at 11.41% (rising 74 bps, Q1 2026); CBRE projects GDP at 2.0% growth in 2026.
→ Cross-references: [Capital Markets](#investment--capital-markets) for how rate easing translated into LA's $37.3B deal volume; [LA Office Market](wiki/la-office-market.md) for how LA employment data relates to office demand; [National CRE Trends](#national-cre-and-cross-sector-context) for 2026 macro outlook.

**[National CRE Trends](wiki/national-cre-trends.md)**
Cross-sector scoreboard (office, industrial, retail, multifamily, life sciences) from JLL, CBRE, and C&W; explicit synthesis of where all three firms agree vs. diverge; LA office vacancy benchmarked against SF (34.4%), NYC (14.1%), Dallas (25.7%); JLL Property Clock places LA in "bottoming out" for both office and industrial Q4 2025.
→ Cross-references: [LA Office Market](wiki/la-office-market.md) and [LA Industrial Market](wiki/la-industrial-market.md) for LA-specific detail behind the national benchmarks; [Capital Markets](#investment--capital-markets) for the CBRE $562B and JLL 19% global volume growth figures.
...
- "Is LA office recovering or still declining?"
...
- Cite the wiki page or raw source the answer draws from
- If a question spans multiple wiki pages, synthesize across them — do not answer from one alone
- If the answer isn't in the knowledge base, say so explicitly — do not infer from general knowledge
- Quantitative data (REIT financials, FRED macro series, BLS employment) lives in Snowflake/Streamlit, not here
...
| Cushman & Wakefield | LA Office Q2 2025 (full submarket table), LA Industrial Q1/Q2/Q3 2025, national context                                                                                                                                                                 |
